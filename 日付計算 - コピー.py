...
def calculate_date():
    ...
    last_day_of_previous_month = first_day_of_previous_month.replace(day=28) + datetime.timedelta(days=4)
    last_day_of_previous_month = last_day_of_previous_month - datetime.timedelta(days=last_day_of_previous_month.day)
