...
def generate_qr_code_wrapper(qr_window, text_entry, date_entry, company_var, device_var):
    ...
    # QRコードのテキストを生成
    qr_text = f"{company}_{device}_{qr_date}_{text}"
...
# QRコード生成ボタン
generate_button = tk.Button(button_frame, text="QRコード生成", command=create_qr_code_window)
generate_button.pack()
